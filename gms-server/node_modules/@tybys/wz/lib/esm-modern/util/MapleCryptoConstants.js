...
export const userKeyWzLib = (function () {
...
export function isDefaultMapleStoryUserKey() {
    ...
    if (MAPLESTORY_USERKEY_DEFAULT.length !== userKeyWzLib.length)
        return false;
    for (let i = 0; i < MAPLESTORY_USERKEY_DEFAULT.length; i++) {
        if (userKeyWzLib[i] !== MAPLESTORY_USERKEY_DEFAULT[i])
            return false;
    }
    return true;
}
export const bShuffle = new Uint8Array([
...
export const bDefaultAESKeyValue = new Uint8Array([
...
export const WZ_OffsetConstant = 0x581C3F6D;
