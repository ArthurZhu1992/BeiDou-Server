export var MAPLESTORY_USERKEY_DEFAULT = new Uint8Array([
...
export var userKeyWzLib = (function () {
    var buf = new Uint8Array(16 * 8);
    buf.set(MAPLESTORY_USERKEY_DEFAULT);
    return buf;
})();
export function isDefaultMapleStoryUserKey() {
    if (!(userKeyWzLib instanceof Uint8Array))
        return false;
    if (MAPLESTORY_USERKEY_DEFAULT.length !== userKeyWzLib.length)
        return false;
    for (var i = 0; i < MAPLESTORY_USERKEY_DEFAULT.length; i++) {
        if (userKeyWzLib[i] !== MAPLESTORY_USERKEY_DEFAULT[i])
            return false;
    }
    return true;
}
export var bShuffle = new Uint8Array([
...
export var bDefaultAESKeyValue = new Uint8Array([
    0xC6, 0x50, 0x53, 0xF2, 0xA8, 0x42, 0x9D, 0x7F, 0x77, 0x09, 0x1D, 0x26, 0x42, 0x53, 0x88, 0x7C
]);
export var WZ_GMSIV = new Uint8Array([0x4D, 0x23, 0xC7, 0x2B]);
export var WZ_MSEAIV = new Uint8Array([0xB9, 0x7D, 0x63, 0xE9]);
// eslint-disable-next-line @typescript-eslint/naming-convention
export var WZ_OffsetConstant = 0x581C3F6D;
