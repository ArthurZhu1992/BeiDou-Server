...
export class WzImageProperty extends WzObject {
    ...
    static async parseLuaProperty(_offset, reader, parent, _parentImg) {
        ...
        const WzLuaProperty = require("./properties/WzLuaProperty.js").WzLuaProperty;
    ...
    static async parsePropertyList(offset, reader, parent, parentImg) {
        ...
        for (let i = 0; i < entryCount; i++) {
            ...
            switch (ptype) {
                case 0: {
                    const WzNullProperty = require("./properties/WzNullProperty.js").WzNullProperty;
                ...
                case 11:
                case 2: {
                    const WzShortProperty = require("./properties/WzShortProperty.js").WzShortProperty;
                ...
                case 3:
                case 19: {
                    const WzIntProperty = require("./properties/WzIntProperty.js").WzIntProperty;
                ...
                case 20: {
                    const WzLongProperty = require("./properties/WzLongProperty.js").WzLongProperty;
                ...
                case 4: {
                    const WzFloatProperty = require("./properties/WzFloatProperty.js").WzFloatProperty;
                ...
                case 5: {
                    const WzDoubleProperty = require("./properties/WzDoubleProperty.js").WzDoubleProperty;
                ...
                case 8: {
                    const WzStringProperty = require("./properties/WzStringProperty.js").WzStringProperty;
    ...
    static async extractMore(reader, offset, _eob, name, iname, parent, imgParent) {
        ...
        switch (iname) {
            case 'Property': {
                const WzSubProperty = require("./properties/WzSubProperty.js").WzSubProperty;
            ...
            case 'Canvas': {
                const WzCanvasProperty = require("./properties/WzCanvasProperty.js").WzCanvasProperty;
                ...
                const WzPngProperty = require("./properties/WzPngProperty.js").WzPngProperty;
            ...
            case 'Shape2D#Vector2D': {
                const WzVectorProperty = require("./properties/WzVectorProperty.js").WzVectorProperty;
                const WzIntProperty = require("./properties/WzIntProperty.js").WzIntProperty;
            ...
            case 'Shape2D#Convex2D': {
                const WzConvexProperty = require("./properties/WzConvexProperty.js").WzConvexProperty;
            ...
            case 'Sound_DX8': {
                const WzBinaryProperty = require("./properties/WzBinaryProperty.js").WzBinaryProperty;
                const soundProp = await WzBinaryProperty.create(name, reader, imgParent.parseEverything);
                soundProp.parent = parent;
                return soundProp;
            }
            case 'UOL': {
                const WzUOLProperty = require("./properties/WzUOLProperty.js").WzUOLProperty;
                reader.pos++;
