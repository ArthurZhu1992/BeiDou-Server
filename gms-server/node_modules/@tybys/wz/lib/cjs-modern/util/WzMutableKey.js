...
class WzMutableKey {
    ...
    ensureKeySize(size) {
        ...
        const r = new binreader_1.BinaryReader(this._iv);
        ...
        const aes = node_1.crypto.createCipheriv('aes-256-ecb', this._aesUserKey, null);
...
exports.WzMutableKey = WzMutableKey;
WzMutableKey._batchSize = 4096;
//# sourceMappingURL=WzMutableKey.js.map